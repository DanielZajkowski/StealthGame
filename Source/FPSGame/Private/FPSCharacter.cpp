...
AFPSCharacter::AFPSCharacter()
{
	...
	CameraComponent->AddRelativeLocation(FVector(0, 0, BaseEyeHeight));
	...
	/*Mesh1PComponent->AddRelativeRotation = FRotator(2.0f, -15.0f, 5.0f);
	Mesh1PComponent->AddRelativeLocation = FVector(0, 0, -160.0f);*/
	Mesh1PComponent->AddRelativeRotation(FRotator(2.0f, -15.0f, 5.0f));
	Mesh1PComponent->AddRelativeLocation(FVector(0, 0, -160.0f));
